...
struct staple_cfg
{
    ...
    double merge_factor = 0.00002;          // fixed interpolation factor - how to linearly combine the two responses
...
public:
	...
	std::string saveImage(string saveImgPath);
	void saveVideo(string saveImgPath, string saveVideoPath, string videoNameTemp, cv::Size imgSize);
